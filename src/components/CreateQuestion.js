...
mutation MyMutation($title: String!, $body: String!, $username: String!, $date: DateTime!) {
    createQuestion(
      data: {title: $title, account: {connect: {username: $username}}, description: $body, date: $date}
    ) {
      id
      date
      title
